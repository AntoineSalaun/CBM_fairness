#!/bin/bash
#SBATCH -o slurm_logs/grid_search_resnet_30_verbs_baseline.sh.log-%j
    ...
    for momentum_value in "${MOMENTUM[@]}"; do
        for step_size_value in "${STEP_SIZE[@]}"; do
            for gamma_value in "${GAMMA[@]}"; do
                ...
                save_folder_balanced="30_verbs/grid_search/baseline/lr_${learning_rate_value}_momentum_${momentum_value}_step_${step_size_value}_gamma_${gamma_value}/balanced"
                result_folder_balanced="results/imSitu/30_verbs/grid_search/baseline/lr_${learning_rate_value}_momentum_${momentum_value}_step_${step_size_value}_gamma_${gamma_value}/balanced"
                path_model_balanced="saved_models/imSitu/30_verbs/grid_search/baseline/lr_${learning_rate_value}_momentum_${momentum_value}_step_${step_size_value}_gamma_${gamma_value}/balanced/model.pt"


                save_folder_imbalanced_1="30_verbs/grid_search/baseline/lr_${learning_rate_value}_momentum_${momentum_value}_step_${step_size_value}_gamma_${gamma_value}/imbalanced_1"
                result_folder_imbalanced_1="results/imSitu/30_verbs/grid_search/baseline/lr_${learning_rate_value}_momentum_${momentum_value}_step_${step_size_value}_gamma_${gamma_value}/imbalanced_1"
                path_model_imbalanced_1="saved_models/imSitu/30_verbs/grid_search/baseline/lr_${learning_rate_value}_momentum_${momentum_value}_step_${step_size_value}_gamma_${gamma_value}/imbalanced_1/model.pt"

                save_folder_imbalanced_2="30_verbs/grid_search/baseline/lr_${learning_rate_value}_momentum_${momentum_value}_step_${step_size_value}_gamma_${gamma_value}/imbalanced_2"
                result_folder_imbalanced_2="results/imSitu/30_verbs/grid_search/baseline/lr_${learning_rate_value}_momentum_${momentum_value}_step_${step_size_value}_gamma_${gamma_value}/imbalanced_2"
                path_model_imbalanced_2="saved_models/imSitu/30_verbs/grid_search/baseline/lr_${learning_rate_value}_momentum_${momentum_value}_step_${step_size_value}_gamma_${gamma_value}/imbalanced_2/model.pt"
