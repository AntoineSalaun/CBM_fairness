...
import math
from fairness_cv_project.datasets.imSitu.legacy.imsitu import imSituVerbRoleLocalNounEncoder 
from fairness_cv_project.datasets.imSitu.legacy.imsitu import imSituTensorEvaluation 
from fairness_cv_project.datasets.imSitu.legacy.imsitu import imSituSituation 
from fairness_cv_project.datasets.imSitu.legacy.imsitu import imSituSimpleImageFolder
from fairness_cv_project.datasets.imSitu.legacy.utils import initLinear
import json
...
class resnet_modified_large(nn.Module):
 def __init__(self):
    ...
    model_path = 'saved_models/resnet101/model.pt'
...
if __name__ == "__main__":
  ...
  parser.add_argument("--image_dir", default="data/datasets/imSitu/original", help="location of images to process")
  parser.add_argument("--dataset_dir", default="data/datasets/imSitu/original_metadata", help="location of train.json, dev.json, ect.") 
