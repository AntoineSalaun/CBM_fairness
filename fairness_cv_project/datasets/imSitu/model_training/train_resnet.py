...
def train(path_dataset: Path, path_save: Path, args: argparse.Namespace):
    ...
    print(model_conv, criterion, optimizer_conv,
...
if __name__ == '__main__':
    ...
    parser.add_argument("--dataset", type=str, default='30_verbs/train_val_split/train_balanced', help="dataset name")
    parser.add_argument("--save_folder", type=str, default='30_verbs/baseline/balanced/', help="name of the saved model")
    ...
    path_save = Path(f'saved_models/imSitu/{args.save_folder}')
