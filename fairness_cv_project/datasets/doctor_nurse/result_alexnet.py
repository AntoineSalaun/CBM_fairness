...
def compute_fairness_metrics(accuracies):
    accuracies['male accuracy'] = (accuracies['doctors_male'] + accuracies['nurses_male']) / 2
    accuracies['female accuracy'] = (accuracies['doctors_female'] + accuracies['nurses_female']) / 2
    accuracies['Doctor-Male group accuracy'] =  (accuracies['doctors_male'] + accuracies['nurses_female']) / 2
    accuracies['Doctor-Female group accuracy'] =  (accuracies['doctors_female'] + accuracies['nurses_male']) / 2
    accuracies['Doctors'] = (accuracies['doctors_male'] + accuracies['doctors_female']) / 2 
    accuracies['Nurses'] = (accuracies['nurses_male'] + accuracies['nurses_female']) / 2 
    accuracies['Total accuracy'] = (accuracies['doctors_male'] + accuracies['nurses_male'] + accuracies['doctors_female'] + accuracies['nurses_female']) / 4
    accuracies['doctors_male_minus_female'] = accuracies['doctors_male'] - accuracies['doctors_female']
    accuracies['nurses_male_minus_female'] = accuracies['nurses_male'] - accuracies['nurses_female']
    return accuracies
...
if __name__ == '__main__':
    ...
    parser.add_argument('--path_result', type=str, help='path to the result')
    ...
    device = args.device
    path_dataset = Path.cwd() / 'data' / 'datasets' / 'doctor_nurse_2' / 'test'
    ...
    if args.load_dir:
        ...
        path_alexnet_model = args.path_alexnet_model
    ...
    with open(path_result / "accuracies.txt", 'w') as f:
